...
#define HRTIM_CR1_ADxUSRC_MASTER      (0x0 << HRTIM_CR1_AD1USRC_SHIFT)
#define HRTIM_CR1_ADxUSRC_TIMA        (0x1 << HRTIM_CR1_AD1USRC_SHIFT)
#define HRTIM_CR1_ADxUSRC_TIMB        (0x2 << HRTIM_CR1_AD1USRC_SHIFT)
#define HRTIM_CR1_ADxUSRC_TIMC        (0x3 << HRTIM_CR1_AD1USRC_SHIFT)
#define HRTIM_CR1_ADxUSRC_TIMD        (0x4 << HRTIM_CR1_AD1USRC_SHIFT)
#define HRTIM_CR1_ADxUSRC_TIME        (0x5 << HRTIM_CR1_AD1USRC_SHIFT)
...
#define HRTIM_EECR_EExSRC_SHIFT(x) (1 << ((x) * 6 - 6))
...
#define HRTIM_EECR3_EExF_SHIFT(x) (1 << ((x - 6) * 4))
...
/* FLTxF: FLTxF */
#define HRTIM_FLTINR1_FLTxF_SHIFT(x) (1 << ((x) * 8 - 5))
